...
import { getSidebarConfig, NavItem, NavSection } from '@/config/sidebarConfig';
...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const sidebarConfig = user?.role
    ? getSidebarConfig(user.role as SystemRole)
    : getSidebarConfig(SystemRole.DEPARTMENT_EMPLOYEE);
  ...
  const getIcon = (iconName: string) => {
    ...
    switch (iconName) {
      ...
      case 'calendar-check':
        return (
          <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2zM9 16l2 2 4-4" />
          </svg>
        );
      case 'clipboard-list':
        return (
      ...
      case 'git-branch':
        return (
          <svg className={iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18a3 3 0 100-6 3 3 0 000 6zM18 9a3 3 0 100-6 3 3 0 000 6zM6 12V6M18 9v3a2 2 0 01-2 2H8a2 2 0 00-2 2v3" />
          </svg>
        );
      default:
        return (
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-card border-r border-border z-50 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-0 flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
        {/* Logo */}
