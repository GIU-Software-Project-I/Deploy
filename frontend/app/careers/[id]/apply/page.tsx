...
import ConsentCheckbox from '@/components/recruitment/compliance/ConsentCheckbox';
import GdprTooltip from '@/components/recruitment/compliance/GdprTooltip';
import DataUsageNotice from '@/components/recruitment/compliance/DataUsageNotice';
import {
  ArrowLeft,
  CheckCircle2,
  XCircle,
