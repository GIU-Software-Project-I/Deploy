      ...
      <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link href="/dashboard/department-employee/payroll-tracking/payslips">
            <button className="w-full p-4 bg-white border border-slate-200 rounded-lg shadow-sm hover:shadow-md hover:border-blue-400 transition-colors text-center group">
                <div className="text-2xl mb-2"></div>
              <p className="font-medium text-slate-900 group-hover:text-slate-900 text-sm">Download Latest Payslip</p>
            </button>
          </Link>
          <Link href="/dashboard/department-employee/payroll-tracking/claims-disputes">
            <button className="w-full p-4 bg-white border border-slate-200 rounded-lg shadow-sm hover:shadow-md hover:border-orange-400 transition-colors text-center group">
              <div className="text-2xl mb-2"></div>
              <p className="font-medium text-slate-900 group-hover:text-slate-900 text-sm">Submit New Claim</p>
            </button>
          </Link>
          <Link href="/dashboard/department-employee/payroll-tracking/tax-documents">
            <button className="w-full p-4 bg-white border border-slate-200 rounded-lg shadow-sm hover:shadow-md hover:border-amber-400 transition-colors text-center group">
              <div className="text-2xl mb-2"></div>
              <p className="font-medium text-slate-900 group-hover:text-slate-900 text-sm">Tax Documents</p>
            </button>
          </Link>
          <Link href="/dashboard/department-employee/payroll-tracking/claims-disputes">
            <button className="w-full p-4 bg-white border border-slate-200 rounded-lg shadow-sm hover:shadow-md hover:border-red-400 transition-colors text-center group">
              <div className="text-2xl mb-2"></div>
              <p className="font-medium text-slate-900 group-hover:text-slate-900 text-sm">Report Issue</p>
            </button>
          </Link>
        </div>
      </div>
