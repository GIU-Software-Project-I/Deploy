        ...
        <div className="max-w-4xl mx-auto p-6 lg:p-10">
          ...
          <div className="bg-card border border-border rounded-3xl p-12 lg:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-24 h-24 bg-muted border-2 border-border rounded-full flex items-center justify-center mx-auto mb-8 shadow-inner">
                {hasUploadedDocs ? (
              ...
              {hasUploadedDocs ? (
                ...
                <>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-3 px-8 py-4 bg-foreground text-background font-semibold rounded-full hover:bg-foreground/90 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                  >
