...
import { PerformanceService, TemplateSearchQuery, CycleSearchQuery, AssignmentSearchQuery, RecordSearchQuery, DisputeSearchQuery } from '../service/performance.service';
...
export class PerformanceController {
    ...
    async resolveDispute(@Param('id') id: string, @Body() dto: ResolveAppraisalDisputeDto, @CurrentUser() user: JwtPayload) {
        return this.performanceService.resolveDispute({
            ...dto,
            disputeId: id,
            resolvedByEmployeeId: user?.sub || dto.resolvedByEmployeeId
        });
    }
